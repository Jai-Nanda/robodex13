...
export default function Home() {
  return (
   ...
   <div style={{
    ...
    }} className="max-w-6xl mt-5 mb-10  m-auto  rounded-lg h-[750px]">
   ...
   <div className=" max-w-6xl bg-bg-colors shadow-nav m-auto rounded-lg backdrop-filter backdrop-blur-sm bg-opacity-60 pb-5  ">
